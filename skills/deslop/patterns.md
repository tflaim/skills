# Deslop: full pattern reference

25 AI writing patterns with "words to watch" lists and before/after examples. Organized by category.

**Note on overlap:** Patterns 1 (significance inflation), 4 (promotional language), and 7 (AI vocabulary) share some trigger words ("vibrant", "pivotal", "crucial"). The distinction: Pattern 1 = editorializing importance, Pattern 4 = advertising tone, Pattern 7 = word-level substitution. The same sentence may trigger multiple patterns -- apply whichever fix is most relevant.
...
### 8. Copula avoidance ("is"/"are" avoidance)
...
### 25. Negation-correction framing

The single most recognizable AI writing pattern in 2026. AI loves to negate one framing and then assert a "corrected" one. It feels clever but it's a tic.

**All variations to catch:**
...
**Words to watch:** "isn't just", "not merely", "forget [noun]", "less [noun] more [noun]", "stop thinking of it as", "it's not about"

**Before:**
> This isn't a chatbot. This is a reasoning engine. It's not about answering questions. It's about understanding intent. Forget customer service. Think customer intelligence.

**After:**
> It's a reasoning engine that parses customer intent before generating a response.

**Why this matters:** The negation adds zero information. "This isn't a chatbot, it's a reasoning engine" says exactly the same thing as "it's a reasoning engine." The negation is filler that creates a false sense of revelation. Delete the negation, keep the positive claim.

---

## Full worked example

**Input (maximally AI-sounding):**
...
>
> This isn't just a productivity tool. This is a paradigm shift. Forget autocomplete. Think autonomous engineering. It's not about writing code faster. It's about rethinking how code gets written.
>
